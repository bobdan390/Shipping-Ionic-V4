...
export class CheckoutPage implements OnInit {
  ...
  ionViewDidEnter() {
    ...
    this.storage.get('ColaInCart').then((ExpressInCart) => {
        if(ExpressInCart != null) {
          	...
          	this.finish_address=ExpressInCart.finish_address;
      			...
      			this.nota=ExpressInCart.nota;
            this.tipo=ExpressInCart.tipo;
  ...
  completarOrden(){
    ...
    this.GlobalService._post("orders/guardar-cola", this.ExpressInCart).subscribe(orderSave => {
